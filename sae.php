...
if ($id > 0) {
    ...
    $sae = mysqli_fetch_assoc($resultat_brut);
...
<head>
    ...
    <title>SAÉ <?php echo htmlspecialchars_decode($sae['titre']); ?> - SAÉ 203</title>
...
<body>
    ...
    <main class="conteneur-principal conteneur-1280">
        ...
        <section class="liste-projets">
            <div class="projet">
                <img src="ressources/images/projet1.jpg" alt="Projet 1">
                <div class="textes">
                    <h2 class="titre">Titre du Projet 1</h2>
                    <p class="description">Description brève du projet 1...</p>
                </div>
            </div>
            <div class="projet">
                <img src="ressources/images/projet2.jpg" alt="Projet 2">
                <div class="textes">
                    <h2 class="titre">Titre du Projet 2</h2>
                    <p class="description">Description brève du projet 2...</p>
                </div>
            </div>
            <div class="projet">
                <img src="ressources/images/projet3.jpg" alt="Projet 3">
                <div class="textes">
                    <h2 class="titre">Titre du Projet 3</h2>
                    <p class="description">Description brève du projet 3...</p>
                </div>
            </div>
        </section>
    </main>
