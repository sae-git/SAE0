...
<body>
<header class="fixed w-full top-0 left-0 bg-white z-50 shadow-md">    </header>
    ...
    <?php while ($article = mysqli_fetch_array($resultat_brut)) { ?>
        <a href="article.php?id=<?php echo $article["id"]; ?>" class='article'>
            <figure>
                <img src='<?php echo $article["lien_image"] ?>' alt="L'image de l'article">
            </figure>
    ...
    <?php } ?>
            ...
            <a class="jpo-banniere" title="Ouverture dans un nouvel onglet" target="_blank"
                ...
                <section class="textes">
                    ...
                    <p class="txt-grand">
                        27/01/<?php echo date('Y') ?>,<br /> de 10h à 17h
                    </p>
