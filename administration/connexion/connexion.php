...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $password_correct = password_hash("SAE203", PASSWORD_DEFAULT);

    if (!empty($password) && password_verify($password, $password_correct)) {
        session_start();
...
<body>
    ...
    <main>
        <div class="mx-auto max-w-7xl py-6 sm:px-6 lg:px-8">
            <div class="py-6">
                <form method="POST" action="administration/connexion/connexion.php"
