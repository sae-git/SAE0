...
if ($formulaire_soumis) {
    if (
        ...
        $lien_avatar = !empty($_POST["lien_avatar"]) ? htmlentities($_POST["lien_avatar"]) : 'https://cdn.pixabay.com/photo/2015/10/05/22/37/blank-profile-picture-973460_960_720.png';
